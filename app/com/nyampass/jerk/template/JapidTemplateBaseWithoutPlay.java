...
import com.nyampass.jerk.MyTuple2;
import com.nyampass.jerk.tags.Each.BreakLoop;
import com.nyampass.jerk.tags.Each.ContinueLoop;
...
import com.nyampass.jerk.util.HTMLUtils;
...
//		writeString(s);
	...
	// public com.nyampass.jerk.template.RenderResult
	// renderModel(com.nyampass.jerk.template.JapidModelMap model) {
	...
	// try {
	// return (com.nyampass.jerk.template.RenderResult )
	...
	public com.nyampass.jerk.template.RenderResult render(NamedArgRuntime... named) {
		Object[] args = null;
	 ...
	 * @return
	 */
	protected com.nyampass.jerk.template.RenderResult runRenderer(Object[] args) {
		try {
			return (com.nyampass.jerk.template.RenderResult) renderMethodInstance.invoke(this, args);
		} catch (IllegalArgumentException e) {
			throw new RuntimeException(e);
		} catch (IllegalAccessException e) {
			throw new RuntimeException(e);
...
//	}
	...
	protected com.nyampass.jerk.template.RenderResult getRenderResult() {
		return new com.nyampass.jerk.template.RenderResult(getHeaders(), getOut(), renderingTime);
	}
